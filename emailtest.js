...
// Due to the nature of my web app, the only testing measaure I was looking to
// implement was the ensurance that valid emails were passed into the database
// and non-valid emails were filtered out this relies upon the application of
// the regex to filter the most amount of valid emails regexone from the test
// filtered 14/17 the possible emails, performing better than
// regextwo which allowed 39 entries, 22 more than the 17 valid
// emails in the emailarray.
...
// perhaps a more trivial example but in an aim to implement property
// based testing I used fast-check to generate various arrays of
// strings, these arrays will contain no valid emails and thus no
// strings should be passed. fastbeck must be uncommented and
